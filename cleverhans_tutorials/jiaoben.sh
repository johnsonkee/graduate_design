...
python3 mnist_keras_at.py --save_model True --model_type a --origin_method bin
...
python3 mnist_keras_at.py --save_model True --model_type b --origin_method bin
...
python3 mnist_keras_at.py --save_model True --model_type c --origin_method bin
