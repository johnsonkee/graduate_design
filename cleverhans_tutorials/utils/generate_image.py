...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
                   ...
                   filename=FILENAME, load_model=LOAD_MODEL,attack=ATTACK,
...
#        assert X_test.shape[0] == test_end - test_start, X_test.shape
  ...
  adv_image = sess.run(adv_x,feed_dict={x:x_test})
  np.save("adv_{}.npy".format(attack),adv_image)
...
if __name__ == '__main__':
  ...
  flags.DEFINE_string('attack',ATTACK, 'attack method:fgsm(default),bim,mifgsm')
  tf.app.run()
